...
namespace SingleMachineTotalWeightedTardinessProblem
{
    ...
    {
        private static int PopulationCount = 20; // Number of individuals in population
        private static int NumberOfRepeats = 7; // Number of best solution repeats: algorithm stops when counter reaches it
        private static int NumberOfChildren = PopulationCount; // Number of children generated by parents
        private static double MutationProbability = 0.3; // Probability of mutations in new child
